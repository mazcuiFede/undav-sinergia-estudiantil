...
const HacerPregunta = (props) => {
  ...
  const handleChangeTipoDuda = (event) => {
    setTipoDuda(event.target.value)
  }
  ...
  const guardarDuda = () => {
    ...
    if (
      ...
      dudasService
        .guardarDuda(titulo, descripcion, tags, tipoDuda)
        .then((response) => {
          setTipoDuda("")
          setTitulo("")
          setDescripcion("")
  ...
  return (
    <Grid container>
      <Grid item xs={12}>
        ...
        <Typography>
          A continuación, podes dejar tu duda para que tus compañer@s puedan
          ayudarte
        </Typography>
      </Grid>
      <Grid align="center" mb={3} mt={2} item xs={12}>
        <Paper
          elevation={10}
          style={{ padding: 20, width: 600, margin: "10px auto" }}
        >
          <Stack spacing={2}>
            ...
            <TextField
              ...
              label="Tags"
              variant="outlined"
              helperText="Ingrese los tags separados por espacios"
            />
            ...
            {showError && (
              <Alert variant="outlined" severity="error">
                Hubo un error al cargar tu pregunta, asegurate de que{" "}
                <b>todos</b> los campos están cargados correctamente.
              </Alert>
            )}

            <Button variant="contained" onClick={guardarDuda}>
              Guardar Duda
            </Button>
          </Stack>
        </Paper>
