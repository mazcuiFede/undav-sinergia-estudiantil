...
export const RouterConfig = () => {
  return (
    <Routes>
      ...
      />
      <Route
        path={FORO_UNIVERSIDAD}
        element={
          <PrivateRoute>
            <Layout children={<ForoUniversidadPage />} />
          </PrivateRoute>
        }
      />
      <Route
        ...
        element={
          <PrivateRoute>
            <Layout children={<ForoTrabajoPage />} />
          </PrivateRoute>
        }
      />
      <Route
        path={FORO_TECNOLOGIA}
        element={
          <PrivateRoute>
            <Layout children={<ForoTecnologiaPage />} />
          </PrivateRoute>
        }
      />
      <Route
      ...
      <Route
        ...
        element={
          <PrivateRoute>
            <Layout children={<HacerPregunta />} />
          </PrivateRoute>
        }
      />
      <Route
        path={POSTULARME_ADMIN}
        element={
          <PrivateRoute>
            <Layout children={<PostularmeAdmin />} />
          </PrivateRoute>
        }
      />
    </Routes>
