      ...
      >
        ...
        <SideNav.Nav selected={selected}>
          <NavItem eventKey="/principal">
            ...
            <NavText title="Principal">Principal</NavText>
          </NavItem>
          ...
          <NavItem eventKey="/foro">
            ...
            <NavText title="foro">Foro</NavText>
            ...
            <NavItem eventKey="/foro/trabajo">
              <NavText title="Dudas Laborales">Dudas Laborales</NavText>
            </NavItem>
            <NavItem eventKey="/foro/tecnologia">
              <NavText title="Dudas técnicas">Dudas Técnicas</NavText>
            </NavItem>
          </NavItem>
          ...
          <NavItem eventKey="/eventos">
            ...
            <NavText title="Eventos">Eventos</NavText>
          </NavItem>
          ...
          <NavItem eventKey="/hacer-pregunta">
            ...
            <NavText title="hacerpregunta">Hacer Pregunta</NavText>
          </NavItem>
          ...
          <NavItem eventKey="/postularme-admin">
            ...
            <NavText title="postularme admin">Postularme Admin</NavText>
          </NavItem>
          ...
          <NavItem eventKey="/login">
            ...
            <NavText title="Cerrar Sesión">Cerrar Sesión</NavText>
          </NavItem>
        </SideNav.Nav>
      </SideNav>
